    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <ul class="nav nav-tabs" style="margin-bottom:15px;">
                <li class="active"><a href="<?php echo site_url($this->config->item("role_view", "routes_uri") . "/" . $current_role["id"]); ?>"><b>Role Settings</b></a></li>
                <li><a href="<?php echo site_url($this->config->item("role_permission_view", "routes_uri") . "/" . $current_role["id"]); ?>">Permission List</a></li>
            </ul>
            
            <div class="bs-callout bs-callout-red">
                <h4>Using Role</h4>
                <p>Use role setting page to assign users to this role. To add or remove permission available to this role, click <a href="<?php echo site_url($this->config->item("role_permission_view", "routes_uri") . "/" . $current_role["id"]); ?>"><b>Permission List</b></a>.</p>
            </div>
            
            <div class="clearfix">
                <?php if($this->matrix->checkSingleAccess($this->config->item("role_update", "routes_uri"), "*")){?>      
                <div class="pull-left button-height">
                    <a href="<?php echo site_url($this->config->item("role_update", "routes_uri") . "/" . $current_role["id"]); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i> Update Role</a>
                    <button type="button" class="btn btn-danger delete-button" data-uri="<?php echo site_url($this->config->item("role_delete", "routes_uri") . "/" . $current_role["id"]); ?>" data-role="<?php echo htmlspecialchars($current_role["roles_name"], ENT_QUOTES); ?>"><i class="fa fa-times"></i> Delete Role</button>
                </div>
                <?php } ?>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered table-blue">
                    ...
                    <tbody> 
                        <tr>
                            <td>Role Name</td>
                            <td><?php echo $current_role["roles_name"]; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
